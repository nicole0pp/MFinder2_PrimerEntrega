    ...
    describe('Service methods', () => {
      ...
      describe('hasAuthority', () => {
        it('should return false if user is not logged', async () => {
          // 'ROLE_USER_ARTIST'
          const hasAuthority = [await service.hasAuthority('ROLE_USER'), await service.hasAuthority('ROLE_USER_ARTIST')];
      ...
      describe('hasAnyAuthority', () => {
        it('should return false if user is not logged', async () => {
          const hasAuthority = await service.hasAnyAuthority(['ROLE_USER', 'ROLE_USER_ARTIST']);
          expect(hasAuthority).toBeFalsy();
        });
        ...
        it('should return true if user is logged and has authority', async () => {
          ...
          const hasAuthority = await service.hasAnyAuthority(['ROLE_USER', 'ROLE_USER_ARTIST', 'ROLE_ADMIN']);
