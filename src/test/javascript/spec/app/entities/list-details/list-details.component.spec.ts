...
import { ListDetailsComponent } from 'app/entities/list-details/list-details.component';
...
describe('Component Tests', () => {
  describe('ListDetails Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.listDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
